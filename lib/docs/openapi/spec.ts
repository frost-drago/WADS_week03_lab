...
export function getOpenApiSpec(baseUrl: string): object {
  return {
    ...
    tags: [
      ...
      {
        name: "Better Auth",
        description: "Email/password and session (Better Auth)",
      },
      {
        name: "Todos",
        description: "Todo list CRUD (requires session cookie)",
      },
    ],
    paths: {
      "/api/session": {
          ...
          parameters: [
            {
              ...
              schema: { type: "string" },
              description:
                "Better Auth path, e.g. sign-in/email, sign-up/email, sign-out",
            },
          ],
          requestBody: {
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  description:
                    "Varies by endpoint (e.g. email, password, name for sign-up)",
                },
              },
            },
          },
      ...
      "/api/todos": {
        get: {
          ...
          summary: "List todos",
          description:
            "Returns all todos for the authenticated user. Requires session cookie.",
        ...
        post: {
          ...
          summary: "Create todo",
          description:
            "Creates a new todo for the authenticated user. Requires session cookie.",
      ...
      "/api/todos/{id}": {
        patch: {
          ...
          summary: "Update todo",
          description:
            "Updates an existing todo by id. Only the owner can update. Requires session cookie.",
        ...
        delete: {
          ...
          summary: "Delete todo",
          description:
            "Deletes a todo by id. Only the owner can delete. Requires session cookie.",
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          description:
            "Firebase ID token from the client (e.g. after signInWithPopup).",
        },
        cookieAuth: {
          type: "apiKey",
          in: "cookie",
          name: "session",
          description:
            "Session cookie set after sign-in (Firebase or Better Auth). Send automatically by the browser.",
        },
      },
      schemas: {
        SessionSuccess: {
